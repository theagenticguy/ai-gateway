...
| <a name="input_portkey_image"></a> [portkey\_image](#input\_portkey\_image) | Docker image URI for the AI Gateway (custom-built from Portkey OSS, pushed to ECR by release workflow) | `string` | `"ai-gateway:latest"` | no |
