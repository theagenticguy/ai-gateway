# ADR-005: ALB JWT Validation Over API Gateway for Auth
...
- [Medium: ALB Native JWT Validation Walkthrough](https://medium.com/@mehulkothari14/aws-alb-native-jwt-validation-515cc3f72351)
