---
title: "ADR-002: python:3.13-slim Over Chainguard"
description: Chose python:3.13-slim with multi-stage hardening over Chainguard due to free-tier version pinning limitations.
sidebar:
  order: 2
---
