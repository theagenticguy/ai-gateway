---
title: "ADR-013: Identity Center SAML/OIDC Federation"
description: SAML 2.0 and OIDC federation with Cognito for user SSO, with Pre-Token Lambda for IdP group-to-claim mapping.
sidebar:
  order: 13
---
